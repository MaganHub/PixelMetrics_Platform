                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Sign in to your PixelMetrics account
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5"
                        >
                            Sign In
                        </button>
                    </form>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="#" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-700 dark:hover:text-indigo-300">
                            Sign up for free
                        </a>
                    </p>
                </div>
